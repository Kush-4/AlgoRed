  ...
  Expanded calenderBodyWidget(BuildContext context) {
    return Expanded(
      child: CalendarCarousel(
        ...
        selectedDayButtonColor: Colors.black12,
        selectedDayBorderColor: CustomColors.primaryColor,
        selectedDayTextStyle: TextStyle(color: Colors.black),
        daysHaveCircularBorder: true,
        isScrollable: false,
        todayButtonColor: CustomColors.themepurple,
      ),
    );
  }
...
Container buildContainerBottomNav(IconData icon, bool isSelected) {
  return Container(
    ...
    width: 50,
    child: Icon(icon,
        color: isSelected ? CustomColors.themepurple : Colors.white),
  );
}
