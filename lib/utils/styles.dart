...
class CustomColors {
  static const Color primaryColor = Color(0xFFE5F6E7);
  static Color secondaryColor = Color(0xFFffebbb);
  static Color accentColor = Color(0xFFF3A25B);
  ...
  static Color themepurple = Color(0xFF4C3575);
}